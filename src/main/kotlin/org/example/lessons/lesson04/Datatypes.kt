package org.example.org.example.lessons.lesson04
...
class Datatypes {
    ...
    //val v6: Bool = FALSE - тут строчная false
    // val v7: Char = 'c' - кавычки должны быть "", если это String
    val v8: Int = 500
    ...
    //val v30: Bool = FALSE - тут строчная false
